...
\newacronym[
    description={Proyecto o trabajo a realizar al final de una titulación de Grado},
    longplural={Trabajo Fin de Grado}
    ]{tfg}{TFG}{Trabajo Fin de Grado}
\newacronym[
    description={Proyecto o trabajo a realizar al final de una titulación de Máster},
    longplural={Trabajo Fin de Máster}
